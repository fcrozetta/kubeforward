# Soren Skill Inventory

- **C++ CLI implementation**: CMake + vcpkg manifest workflows, modular layouting (`cmd/`, `src/`, `include/`).
- **Dependency ops**: pin/update `vcpkg.json` baselines, align local `VCPKG_ROOT`, and troubleshoot manifest installs.
